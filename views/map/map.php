...
<div class="row">
    <div class="col-sm-9">
        ...
        <?php
            switch( $detail ){
                case "regions": include("maps/france_regions.php"); break;
                case "departements": include("maps/france_departements.php"); break;
                case "arrondissements": include("maps/france_arrondissements.php"); break;
            }
            initMap($map);
        ?>
